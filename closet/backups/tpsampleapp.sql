...
-- Dump completed on 2014-04-15  7:00:56
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.8 (x86_64)
--
-- Host: localhost    Database: tpsampleapp
-- ------------------------------------------------------
...
CREATE TABLE `lti2_tp_registrations` (
  ...
  `tool_id` int(11) DEFAULT NULL,
  `lti_version` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `end_registration_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `proposed_tool_proxy_json` text COLLATE utf8_unicode_ci,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- Dump completed on 2014-06-18 16:43:59
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.8 (x86_64)
--
-- Host: localhost    Database: tpsampleapp
-- ------------------------------------------------------
...
-- Dump completed on 2014-06-29 10:12:47
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.8 (x86_64)
--
-- Host: localhost    Database: tpsampleapp
-- ------------------------------------------------------
...
-- Dump completed on 2014-06-29 10:22:04
...
-- Dump completed on 2014-07-22 14:42:29
